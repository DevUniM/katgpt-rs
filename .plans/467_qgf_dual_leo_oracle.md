...
- Promotion decision from opt-in to "documented as recommended" — **BLOCKED on positive G5 measurement** (none in hand across two measurement regimes; reopen triggers: mmorpg-remake integration gain, new game domain positive G5, or Q-vs-forecast research breakthrough).
