...
| **ShardIndex snapshot** | `mmorpg-remaster/crates/mmorpg-asset-explorer/src/index.rs` | papaya lock-free HashMap zone→shard lookup | **Latent** (local, but must be atomic) |
