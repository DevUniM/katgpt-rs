...
|------|-----|------|-----------------|
| Shard retrieval (hot) | 8 | `mmorpg-remaster/crates/mmorpg-asset-explorer/src/index.rs` `ShardIndex::query` | `cosine_sim_ranking_scaled` (squared cosine, no sqrt) |
| Shard KNN (cold) | 8 | `mmorpg-remaster/crates/mmorpg-asset-explorer/src/index.rs` `query_k_nearest_cosine` | `cosine_sim` (full cosine) |
