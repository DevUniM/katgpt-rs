...
**Status:** DISTILLED — 3 GOAT-tier primitive candidates filed as [Issue 873](../.issues/873_mini_agi_governed_pool_primitives.md); training-track rows filed as [riir-train Research 456](../../riir-train/.research/456_Mini_AGI_Trunk_LR_Continual_Recipe.md) + [Plan 416](../../riir-train/.plans/416_mini_agi_trunk_lr_plasticity_forgetting_probe.md).
...
Not Super-GOAT: no all-4 column. All three file under [Issue 873](../.issues/873_mini_agi_governed_pool_primitives.md) as opt-in katgpt-core features, GOAT-gated, report-first where the R135/Bench-047 law applies.
