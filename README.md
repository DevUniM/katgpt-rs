...
The default production stack has **204 GOAT-proved default-on features** (641 total flags), but they don't all run on every token. The architecture uses **layered gating** — most features are bandit-driven, Option-gated, or compile-time-only.
