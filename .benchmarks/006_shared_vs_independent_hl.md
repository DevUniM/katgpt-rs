...
| `mmorpg-remaster/crates/mmorpg-gm-tools/src/tabs/players.rs` | `HLPlayer::with_shared_stats()`, public accessors |
| `katgpt-rs/crates/katgpt-ruliology/src/bandit.rs` | `SharedBanditStats` |
