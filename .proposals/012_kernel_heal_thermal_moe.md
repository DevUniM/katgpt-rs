...
Related: riir-clippy Bench 009 (cache-vs-compute silent-miss lesson — removed-file series, read via `git show` in riir-clippy), `Bench 029` (CubeCL GeGLU bug — the canonical class a healer catches), `Research 440` (KernelBench reward-hacking 63%→34%)
